<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <!--   编辑与删除   -->
      <el-table-column
        v-permission="['category_desc_update','category_desc_delete']"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudJob from '@/api/product/categorydesc'
...
export default {
  ...
  cruds() {
    ...
    return CRUD({
      title: '商品分类语言',
      url: 'admin/category_desc/page_list',
  ...
  data() {
    return {
      permission: {
        add: ['category_desc_add'],
        edit: ['category_desc_update'],
        del: ['category_desc_delete']
      }
    }
  },
  methods: {
