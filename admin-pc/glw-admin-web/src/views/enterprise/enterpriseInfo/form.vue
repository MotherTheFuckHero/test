...
import { getEnterpriseList, expensesTypeList, enterpriseUserList } from '@/api/enterprise/enterpriseInfo'
...
export default {
  ...
  created() {
    ...
    enterpriseUserList(data).then(res => {
      this.enterpriseUserList = res.data
    })
