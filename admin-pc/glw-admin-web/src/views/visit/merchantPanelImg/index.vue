<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <!--   编辑与删除   -->
      <el-table-column
        v-permission="['merchant_panel_img_update','merchant_panel_img_delete']"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudJob from '@/api/visit/merchantPanelImg'
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '商家板块轮播图管理',
      url: process.env.VUE_APP_visit_API + 'admin/merchant_panel_img/page_list',
      crudMethod: { ...crudJob }
    })
  },
  mixins: [presenter()],
  ...
  data() {
    return {
      permission: {
        add: ['merchant_panel_img_add'],
        edit: ['merchant_panel_img_update'],
        del: ['merchant_panel_img_delete']
      }
    }
  },
  methods: {
