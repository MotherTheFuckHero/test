<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="100px">
      <el-form-item label="商家板块" prop="merchantPanelId">
        <el-select v-model="form.merchantPanelId" style="width: 200px;" clearable filterable>
          <el-option
      ...
      <el-form-item label="类型" prop="type">
        <el-select v-model="form.type" clearable style="width: 200px;" placeholder="类型" @change="typechange">
          <el-option
      ...
      <el-form-item label="链接地址" prop="linkUrl">
        <el-input v-model="form.linkUrl" maxlength="255" style="width: 200px;" />
      </el-form-item>
      <el-form-item label="阅读量" prop="readCount">
        <el-input v-model="form.readCount" maxlength="255" style="width: 200px;" />
      </el-form-item>
