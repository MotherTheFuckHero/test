  ...
  <div id="bottomLeft">
    <div class="bg-color-blacks">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          <span class="fs-xl text mx-2s">酒店人流量统计(人)</span>
        </div>
      </div>
      <div>
        <div style="float: right;font-weight: bold;font-size: 0.23rem;margin-right: 0.1rem;color: #48abff !important">
          接待总数:
          <count-to :start-val="0" :end-val="number" :duration="1000" class="card-panel-num" style="color: #0febff;font-size: 0.3rem;" />
          人
        </div>
        <MainbottomLeftChart />
      </div>
...
<script>
import MainbottomLeftChart from '../../components/echart/bottom/MainbottomLeftChart'
