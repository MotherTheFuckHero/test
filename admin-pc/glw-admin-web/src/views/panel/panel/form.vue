<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="100px">
      ...
      <el-form-item v-if="form.type===2" label="是否为PC导航栏" prop="isNativeBar" label-width="120px">
        <el-radio-group v-model="form.isNativeBar" style="width: 200px;">
...
import { paneltypeList, getpanelLists, panelstyleList } from '@/api/panel/panel'
