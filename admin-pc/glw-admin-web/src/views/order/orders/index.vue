<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-button size="mini" type="primary" @click="genCount()">添加数据</el-button>
    </div>
    <!--表格渲染-->
    ...
    <el-dialog title="订单详情" :visible.sync="dialogTableVisible">
      ...
      <div v-if="ProductsVisible===false">
...
import { agreeRefund, refuse, getorderdetail, reason, orderPrint, cancel, getproductId, getproductIds, getparkingRenew, guiderefund, postlogistic, LogisticsCode, genCount } from '@/api/order/order'
...
export default {
  ...
  cruds() {
    return CRUD({
      ...
      url: 'admin/order_info/make_page_list',
