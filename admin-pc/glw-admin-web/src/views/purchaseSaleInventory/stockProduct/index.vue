<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column prop="stockInfoId" label="退货单号"/>
      ...
      <el-table-column prop="price" label="退货商品价格" />
      <el-table-column prop="totalPrice" label="退货总价" />
      <el-table-column prop="warehouseDesc" label="退货仓库" />
...
<!--      <el-table-column label="创建时间" prop="createdTime" width="200" />-->
    ...
    <el-dialog title="订单详情" :visible.sync="dialogTableVisible" width="1200px" :close-on-click-modal="false">
      ...
      <el-table :data="tableLists">
        ...
        <el-table-column property="refundNum" label="退货数量" width="100" />
        <el-table-column property="refundReason" label="退货原因" width="200" />
