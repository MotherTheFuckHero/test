    ...
    <div class="purchaseOrderDetail">
      <div class="purchaseOrderOne">
        ...
        <div class="purchaseOrderOneContent">
          <h2 style="text-align: center">采购单</h2>
...
<script>
    import { getPurchaseOrderDetail } from '@/api/newInvoicing/purchaseorder'
    export default {
        props: ['getId'],
        data(){
            return{
                    ...
                    if (newData){
                        getPurchaseOrderDetail(newData).then(res => {
                            if (res.code === '0'){
                                ...
                                this.detail.date = res.data.purchaseDate
                                this.tableDataOne = res.data.purchaseItemList
                            }
                        })
                    }
                },
