<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column prop="systemCode" label="系统编码" width="150px" />
      ...
      <!--   编辑与删除   -->
      <el-table-column
        v-permission="['sys_system_update','sys_system_delete']"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '系统管理',
      url: 'admin/sys_system/page_list',
      crudMethod: { ...crudJob }
    })
  },
  mixins: [presenter()],
  ...
  data() {
    return {
      permission: {
        add: ['sys_system_add'],
        edit: ['sys_system_update'],
        del: ['sys_system_delete']
      }
    }
  },
  methods: {
