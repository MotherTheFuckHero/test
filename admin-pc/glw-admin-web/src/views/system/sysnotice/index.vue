<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column prop="noticeTypeDesc" label="类型" width="150px" />
      <el-table-column prop="noticeTitle" label="标题" width="150px" />
      ...
      <!--   编辑与删除   -->
      <el-table-column
        v-permission="['sys_notice_update','sys_notice_delete']"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudJob from '@/api/system/sysnotice'
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '系统公告',
      url: 'admin/sys_notice/page_list',
      crudMethod: { ...crudJob }
    })
  },
  mixins: [presenter()],
  ...
  data() {
    return {
      permission: {
        add: ['sys_notice_add'],
        edit: ['sys_notice_update'],
        del: ['sys_notice_delete']
      }
    }
  },
  methods: {
