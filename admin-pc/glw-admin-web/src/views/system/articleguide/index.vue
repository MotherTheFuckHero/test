<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <!--   编辑与删除   -->
      <el-table-column
        v-permission="['article_guide_update','article_guide_delete']"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudJob from '@/api/system/articleguide'
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '攻略文章',
      url: 'admin/article_guide/page_list',
      crudMethod: { ...crudJob }
    })
  },
  mixins: [presenter()],
  ...
  data() {
    return {
      permission: {
        add: ['article_guide_add'],
        edit: ['article_guide_update'],
        del: ['article_guide_delete']
      }
    }
  },
  methods: {
