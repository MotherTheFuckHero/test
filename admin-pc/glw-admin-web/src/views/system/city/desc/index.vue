<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <!--   编辑与删除   -->
      <el-table-column
        v-permission="['city_desc_update','city_desc_delete']"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudJob from '@/api/system/citydesc'
...
export default {
  ...
  data() {
    return {
      permission: {
        add: ['city_desc_add'],
        edit: ['city_desc_update'],
        del: ['city_desc_delete']
      }
    }
  },
  methods: {
