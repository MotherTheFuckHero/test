<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <!--   编辑与删除   -->
      <el-table-column
        v-permission="['merchant_desc_update','merchant_desc_delete']"
        label="操作"
        width="130px"
        align="center"
        fixed="right"
...
<script>
import crudJob from '@/api/merchant/merchantdesc'
...
export default {
  ...
  cruds() {
    ...
    return CRUD({
      title: '基本信息语言',
      url: 'admin/merchant_desc/page_list',
  ...
  data() {
    return {
      permission: {
        add: ['merchant_desc_add'],
        edit: ['merchant_desc_update'],
        del: ['merchant_desc_delete']
      }
    }
  },
  methods: {
