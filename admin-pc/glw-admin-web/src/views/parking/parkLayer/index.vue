<template>
  <div class="app-container">
    ...
    <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
      ...
      <el-table-column prop="layerName" label="停车场层名称" width="150px" />
      <el-table-column prop="layerSort" label="层排序" width="150px" />
...
<script>
import crudJob from '@/api/parking/parkLayer'
...
export default {
  ...
  cruds() {
    return CRUD({
      title: '停车层数管理',
      url: 'admin/park_layer/page_list',
      crudMethod: { ...crudJob }
    })
  },
  mixins: [presenter()],
