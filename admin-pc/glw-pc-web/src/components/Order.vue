<template>
  <div>
    ...
    <div class="goods-list-container">
      ...
      <Table border ref="selection" aria-labelledby :columns="columns" :data="shoppingCart" size="large" @on-selection-change="select" no-data-text="您的购物车没有商品，请先添加商品到购物车再点击购买">
        <th scope>标题</th>
      </Table>
